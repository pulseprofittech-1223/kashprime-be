...
const ctrl       = require('../controllers/colorPick.controller');
...
router.post('/play',            authMiddleware, limiter,
  [body('stake_amount').isFloat({ min: 0.01 }).withMessage('Stake must be positive'), body('player_choice').isIn(['red','green','blue']).withMessage('Choice must be red, green, or blue')],
