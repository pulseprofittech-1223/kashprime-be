...
const ctrl       = require('../controllers/scratchCard.controller');
...
router.post('/play',            authMiddleware, limiter, [body('stake_amount').isFloat({ min: 0.01 }).withMessage('Stake must be positive')], validate, ctrl.playGame);
